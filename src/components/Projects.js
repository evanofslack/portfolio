        ...
        <div className={classes.root}>
            ...
            <div className={classes.container}>
                <Grid container justify="center" alignItems="flex-start" spacing={0}>
                    ...
                    <Grid item xs={12} sm={6} lg={4} justify="center" alignItems="center">
                        <ProjectCard project="toothbrush" name="Toothbrush Tester" description="Lifetime brushing simulation device"/>
                    </Grid>
                    <Grid item xs={12} sm={6} lg={4} justify="center" alignItems="center">
                    ...
                    <Grid item xs={12} sm={6} lg={4} justify="center" alignItems="center">
                        <ProjectCard project="macropad" name="MacroPad" description="Custom PCB and 3D printed housing"/>
                    </Grid>
                    <Grid item xs={12} sm={6} lg={4} justify="center" alignItems="center">
                    ...
                    <Grid item xs={12} sm={6} lg={4} justify="center" alignItems="center">
                        <ProjectCard project="spotify" name="e-Paper Spotify Clock" description="E-Ink screen that displays my Spotify feed"/>
                    </Grid>
                    <Grid item xs={12} sm={6} lg={4} justify="center" alignItems="center">
